...
function setup_testing_input_output {
  ...
  cp -r ${GRADER_ROOT}/${test_folder}/input  ${TEST_OUTPUT_PATH}
  cp -r ${GRADER_ROOT}/${test_folder}/output ${TEST_OUTPUT_PATH}

}

function compare_outputs {
  NUM_OUTPUT_FILES_PASSED=0
  OUTPUT_FILENAME=order_final_1.dat
  PROJECT_ANSWER_PATH1=${GRADER_ROOT}/temp/output/${OUTPUT_FILENAME}
  TEST_ANSWER_PATH1=${GRADER_ROOT}/${test_folder}/output/${OUTPUT_FILENAME}
